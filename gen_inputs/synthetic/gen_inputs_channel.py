...
out_dir = "../../inputs/channel/"
# File names
out_file = "inputs_flat_high.hdf5"
...
input_file = HDF5File(mpi_comm_world(), '../sims/ref/results_trough_winter/hdf5_results/trough_winter.hdf5', 'a') 
