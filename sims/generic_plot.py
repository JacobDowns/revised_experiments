...
"""
Makes some generic plots of inputs and outputs for all runs in an experiment.
Invoked by:
python generic_plot.py [experiment_name]
Assumes data has already been writen by write_data.py. 
"""
