...
"""
Bump sensitivity experiment with bump heights of 5cm, 10cm, 0.5m, and 1m.
"""
...
### 100cm winter + 3cm basal melt
run9 = bse_experiment.add_run('100_winter1', run3.model_inputs['steady_file'] + '.hdf5', steady = False)
run9.model_inputs['constants']['h_r'] = run3.model_inputs['constants']['h_r']
