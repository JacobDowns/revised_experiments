...
"""
Channel sensitivity experiment. In the first run, channels are enabled. In the
second run, channels are enabled and melt sources are introduced.
"""

cse_experiment = Experiment('cse')

# Ramp up melt over two weeks
...
# Day subdivisions for time step.
N = 300
...
### Summer + 1cm basal melt + englacial storage
...
### Winter + 1cm basal melt + englacial storage
